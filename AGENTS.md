# CLAUDE.md — 물린김에 분석함 (Apps in Toss)
...
| 항목           | 값                                                                     |
| -------------- | ---------------------------------------------------------------------- |
| 앱 이름        | `mullin-gime-bunseokham` (패키지명), `mullin-gime-bunseokham` (granite appName), `물린김에 분석함` (표시명) |
| URL Scheme     | `intoss://mullin-gime-bunseokham`                                      |
| React Native   | 0.84.0                                                                 |
| React          | 19.2.3                                                                 |
...
```
mullin-gime-bunseokham/
├── src/
│   ├── _app.tsx          # 앱 진입점 — 절대 수정 최소화
│   └── pages/            # 실제 페이지 컴포넌트 작성 위치
│       ├── index.tsx     → intoss://mullin-gime-bunseokham
│       └── about.tsx     → intoss://mullin-gime-bunseokham/about
...
| 파일 경로                   | URL                                    |
| --------------------------- | -------------------------------------- |
| `src/pages/index.tsx`       | `intoss://mullin-gime-bunseokham`             |
| `src/pages/about.tsx`       | `intoss://mullin-gime-bunseokham/about`       |
| `src/pages/item/index.tsx`  | `intoss://mullin-gime-bunseokham/item`        |
| `src/pages/item/detail.tsx` | `intoss://mullin-gime-bunseokham/item/detail` |
...
export default defineConfig({
  scheme: 'intoss',
  appName: 'mullin-gime-bunseokham', // Apps in Toss 콘솔 앱 이름과 반드시 일치
  plugins: [
    appsInToss({
      brand: {
        displayName: '물린김에 분석함', // 네비게이션 바 레이블 (한글 가능)
...
2. Scheme 입력: `intoss://mullin-gime-bunseokham`
